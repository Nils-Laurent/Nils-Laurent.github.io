...
{\color{DefaultGray}
	...
	\begin{minipage}{0.85\textwidth}
		\textbf{Maître de conférences} à Roanne rattaché au LASPI et à l'IUT Réseaux \& Télécoms.
	\end{minipage}\\
	\vspace{2mm}
	...
	\begin{itemize}
		...
		\item[*] 2025-... \textbf{IUT de Roanne}: relatif à la prise de poste de maitre de conférences
